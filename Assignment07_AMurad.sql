...
-- 2022-02-26,AMurad,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_AMurad')
	 Begin 
	  Alter Database [Assignment07DB_AMurad] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_AMurad;
	 End
	Create Database Assignment07DB_AMurad;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_AMurad;
...
FROM vCategories as C
 ...
 Inner Join vInventories as I
  ...
  order by CategoryName, Month(InventoryDate), TotalCount
 ;
 go
...
Alter Function fProductInventoriesWithPreviousMonthCountsWithKPIs(@Quantitylevel int)
Returns Table
As
  Return(
  Select
...
[QtychangeKPI]
From vProductInventoriesWithPreviousMonthCountsWithKPIs
          Where QtychangeKPI = @Quantitylevel
);
go
